...
<body>
    ...
    <center>
        <h1>Admin - Mooney Assessment Test</h1>
    </center>
    ...
    // Store results into arrays for natural sorting
    $top_20 = [];
    ...
    // Natural sort Top 20 concerns
    usort($top_20, function ($a, $b) {
        return strnatcmp($a['concern'], $b['concern']);
    });

    // Natural sort Top 5 concerns
    usort($top_5, function ($a, $b) {
        return strnatcmp($a['concern'], $b['concern']);
    });
    ?>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($top_20 as $concern) { ?>
                <tr>
                    <td><?php echo htmlspecialchars($concern['concern']); ?></td>
                    <td><?php echo htmlspecialchars($concern['selection_count']); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
