...
$query = "SELECT first_name, last_name, course_section, email FROM user WHERE user_id = '$user_id'";
...
<body>
    ...
    <h3 style="text-transform: capitalize;">Student Name: <?php echo htmlspecialchars($first_name . " " . $last_name);  ?>| Section: <?php echo htmlspecialchars($course_section); ?></h3>
    ...
    <table>
        ...
        $query = "SELECT * FROM testing_service WHERE user_id = '$user_id'";
        $result = mysqli_query($con, $query);
