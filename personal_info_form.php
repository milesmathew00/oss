    ...
    <?php if (!$top20_submitted): ?>
        <form action="" method="POST" onsubmit="return validateTop20() && confirmSubmit();">
            ...
            <div class="concern-list">
                ...
                <label>Course & Section: Ex Bachelor of Science in Psychology 3A only input the acronym course and year/section(BSP 3A)
                ...
                $concerns = [
                    ...
                    "2.Going into debt for college expenses",
                    "3.Not enough time for recreation",
                    "4.Losing friends",
                    "5.Taking things too seriously",
                    "6.Forgetting things I’ve learned in school",
                    "7.Restless at delay in starting life work",
                    "8.College too indifferent to student needs",
                    "9.Being underweight",
